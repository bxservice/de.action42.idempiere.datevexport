...
public class CSV_Bewegungsdaten_Buchungssatz extends CSV_Buchungssatz {
	...
	public CSV_Bewegungsdaten_Buchungssatz() {
		id = nextId++;
	}
	...
	public final String getUmsatzStr() {
		...
		DecimalFormat umsatzFormat = new DecimalFormat("0.00");
		return umsatzFormat.format(umsatz);
	}
	...
	public void setDatum(final Date newDatum) {
		...
		datum = dateFormat.format(newDatum);
	}
	...
	public final void setBuchungstext(final String newBuchungstext)
		...
		if (newBuchungstext.length() > 60) {
			sbBuchungstext.append(text.substring(0, 60));
		} else {
